package code.name.monkey.retromusic.views.custom.otp;
...
public class OtpView extends MaterialTextView implements View.OnKeyListener {
    ...
    private void moveSelectionToEnd() {
        if (getText() != null) {
            setSelection((Spannable) getText(),getText().length());
        }
    }
